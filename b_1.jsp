          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="C:/Users/Lenovo/Desktop/Digital Village/all_products/all_product.html"><i class="fal fa-bags-shopping"></i>PRODUCT & TRADE</a>
                </li>
                <li class="nav-item">
    ...
    <!---js for product gallery---->
      ...
      <script>
          function change_img(sw)
          {
            var pic;
            if (sw == 0){
               pic="images/b_1_1.jpg"
             }
            else if (sw == 1) {
              pic = "images/b_1_2.jpg"
            }
            else if (sw == 2) {
              pic = "images/b_1_3.jpg"
            }
            else {
              pic = "images/b_1_4.jpg"
            }
       ...
       <div class="single-product">
         <div class="row">
             <div class="col-6 left">
                   <img src="images/b_1_1.jpg" alt="Handmade basket" width="100%" id="myImage">

                   <div class="small-img-row">
                       <div class="small-img-col">
                           <img src="images/b_1_1.jpg" alt="Handmade basket" width="100%"  onclick="change_img(0)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_1_2.jpg" alt="Handmade basket" width="100%" onclick="change_img(1)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_1_3.jpg" alt="Handmade basket" width="100%" onclick="change_img(2)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_1_4.jpg" alt="Handmade basket" width="100%" onclick="change_img(3)">
                       </div>
                   </div>
             </div>
             ...
             <div class="col-6 right">
                 ...
                 <div class="seller-btn">
                    <a href="https://docs.google.com/spreadsheets/d/188kJ_SSPYQazIyXnS2hRpMWNiVIU9-2r-ocEOSihTRw/edit?usp=sharing">SELLER'S DETAILS &#8594;</a>
                 </div>
             </div>
          </div>
       </div>
...
<!---Recommended products--->
  ...
  <div class="recommended">
    <h2>RECOMMENDED  PRODUCTS</h2>
      <div class="row">
        <div class="col-4">
        <a href="b_2.jsp"><img src="images/b_2_1.jpg" height="300px" width="200px"></a>
          <h4>Handmade Cane Flower Pot</h4>
          <p><sup>?</sup>800</p>
          <div class="img-btn">
              <a href="b_2.jsp">Details</a>
          </div>
        </div>

        <div class="col-4">
        <a href="b_3.jsp"><img src="images/b_3_1.jpg" height="300px" width="200px"></a>
          <h4>Handcrafted Cane Plant Stand</h4>
          <p><sup>?</sup>600</p>
          <div class="img-btn">
              <a href="b_3.jsp">Details</a>
          </div>
        </div>

        <div class="col-4">
        <a href="b_7.jsp"> <img src="images/b_7_1.jpg"  height="300px" width="200px"></a>
          <h4>Tulip Handmade Cane Planter</h4>
          <p><sup>?</sup>250</p>
          <div class="img-btn">
              <a href="/b_7.jsp">Details</a>
          </div>
        </div>

        <div class="col-4">
        <a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/flower_pot/flower_pot_links/b_5.html"><img src="images/b_5_1.jpg" height="300px" width="200px"></a>
          <h4>2 Tier Rattan Cane Planter</h4>
          <p><sup>?</sup>700</p>
          <div class="img-btn">
              <a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/flower_pot/flower_pot_links/b_5.html">Details</a>
          </div>
        </div>
