  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
      ...
      *{
      ...
      .container-col-1, .container-col-2
      {
        flex-basis: 25%;
      }
...
<!---All Products--->
  ...
  <div class="container">
    <div class="row">
      <div class="container-col-1">
          ...
          <div class="links">
            <ul>
              ...
              <li><a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/basket/basket.html">Baskets</a></li>
              <li><a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/teracotta/teracotta.html">Decor teracotta pot</a></li>
              <li><a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/face_mask/face_mask.html">Face masks</a></li>
      ...
      <div class="container-col-2">
          <h1>Handmade Flower Pots</h1>
            <div class="collection">
              <div class="row">
                <div class="col-4">
                  <a href="b_1.jsp"><img src="images/b_1_1.jpg" height="320px" width="200px"></a>
                ...
                <div class="col-4">
                  <a href="b_2.jsp"><img src="images/b_2_1.jpg" height="320px" width="200px"></a>
                ...
                <div class="col-4">
                <a href="b_3.jsp"><img src="images/b_3_1.jpg"  height="320px" width="200px"></a>
              ...
              <div class="row">
                <div class="col-4">
                <a href="b_4.jsp"><img src="images/b_4_1.jpg" height="320px" width="200px"></a>
                  <h4>Bamboo Planter Stand </h4>
                  <p><sup>?</sup>350</p>

                </div>
                <div class="col-4">
                <a href="/b_5.jsp"><img src="images/b_5_1.jpg" height="320px" width="200px"></a>
                  <h4>2 Tier Rattan Cane Planter</h4>
                  <p><sup>?</sup>700</p>
                </div>
                <div class="col-4">
                <a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/flower_pot/flower_pot_links/b_6.html"><img src="images/b_6_1.jpg" height="320px" width="200px"></a>
              ...
              <div class="row">
                <div class="col-4">
                <a href="C:/Users/Lenovo/Desktop/Digital Village/all_products/flower_pot/flower_pot_links/b_7.html"><img src="images/b_7_1.jpg" height="320px" width="200px"></a>
                  <h4>Solid Tulip Handmade Cane Planter</h4>
                  <p><sup>?</sup>300</p>
                </div>
              </div>
            </div>
  ...
  <div class="recommended">
    <h2>MORE CATEGEORIES</h2>
      <div class="row">
        <div class="col-4">
          <a href="b_1.jsp"><img src="images/b_2_4.jpg" height="300px" width="200px"></a>
          <h4>3 flower pot</h4>
          <p><sup>?</sup>500</p>
          <div class="img-btn">
              <a href="#">Details</a>
        ...
        <div class="col-4">
          <a href="b_2.jsp"><img src="images/b_2_4.jpg" height="300px" width="200px"></a>
          <h4>3 flower pot</h4>
          <p><sup>?</sup>500</p>
          <div class="img-btn">
              <a href="#">Details</a>
        ...
        <div class="col-4">
          <a href="b_3.jsp"><img src="images/b_2_3.jpg" height="300px" width="200px"></a>
          <h4>3 flower pot</h4>
          <p><sup>?</sup>500</p>
          <div class="img-btn">
              <a href="#">Details</a>
        ...
        <div class="col-4">
        <a href="b_4.jsp"><img src="images/b_2_4.jpg" height="300px" width="200px"></a>
          <h4>3 flower pot</h4>
          <p><sup>?</sup>500</p>
          <div class="img-btn">
              <a href="#">Details</a>
