    ...
    <!---js for product gallery---->
      ...
      <script>
          function change_img(sw)
          {
            var pic;
            if (sw == 0){
               pic="images/b_3_1.jpg"
             }
            else if (sw == 1) {
              pic = "images/b_3_2.jpg"
            }
            else if (sw == 2) {
              pic = "images/b_3_3.jpg"
            }
            else {
              pic = "images/b_3_4.jpg"
            }
       ...
       <div class="single-product">
         <div class="row">
             <div class="col-6 left">
                   <img src="images/b_3_1.jpg" alt="Handmade basket" width="100%" id="myImage">

                   <div class="small-img-row">
                       <div class="small-img-col">
                           <img src="images/b_3_1.jpg" alt="Handmade basket" width="100%"  onclick="change_img(0)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_3_2.jpg" alt="Handmade basket" width="100%" onclick="change_img(1)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_3_3.jpg" alt="Handmade basket" width="100%" onclick="change_img(2)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_3_4.jpg" alt="Handmade basket" width="100%" onclick="change_img(3)">
                       </div>
                   </div>
             </div>
            ...
            <!---Recommended products--->
              ...
              <div class="recommended">
                <h2>RECOMMENDED  PRODUCTS</h2>
                  <div class="row">
                    <div class="col-4">
                    <a href="b_4.jsp"><img src="images/b_4_1.jpg" height="300px" width="200px"></a>
                      <h4>Bamboo Planter Stand</h4>
                      <p><sup>?</sup>300</p>
                      <div class="img-btn">
                          <a href="b_4.jsp">Details</a>
                      </div>
                    </div>
