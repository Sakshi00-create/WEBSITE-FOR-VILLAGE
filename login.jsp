...
<div class="wrapper">
    ...
    <div class="form">
       <div class="inputfield">
          <label>EMAIL</label>
          <input type="text" name="mail" class="input" placeholder="Enter EMAIL">
       </div>
        <div class="inputfield">
      ...
      <div class="inputfield">
        ...
        <input type="submit" value="FORGOT PASSWORD" name="forgot" class="btn" >
      </div>
        <div class="inputfield">
              <label>If you are admin,click here</label>
        <input type="submit" value="ADMIN" name="admin" class="btn" >
      </div>
    </div>
</div>
</form>
