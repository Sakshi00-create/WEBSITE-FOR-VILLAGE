    ...
    <!---js for product gallery---->
      ...
      <script>
          function change_img(sw)
          {
            var pic;
            if (sw == 0){
               pic="images/b_2_1.jpg"
             }
            else if (sw == 1) {
              pic = "images/b_2_2.jpg"
            }
            else if (sw == 2) {
              pic = "images/b_2_3.jpg"
            }
            else {
              pic = "images/b_2_4.jpg"
            }
     ...
     <div class="main-col-2">
       <div class="single-product">
         <div class="row">
             <div class="col-6 left">
                   <img src="images/b_2_1.jpg" alt="Handmade basket" width="100%" id="myImage">

                   <div class="small-img-row">
                       <div class="small-img-col">
                           <img src="images/b_2_1.jpg" alt="Handmade basket" width="100%"  onclick="change_img(0)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_2_2.jpg" alt="Handmade basket" width="100%" onclick="change_img(1)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_2_3.jpg" alt="Handmade basket" width="100%" onclick="change_img(2)">
                       </div>
                       <div class="small-img-col">
                           <img src="images/b_2_4.jpg" alt="Handmade basket" width="100%" onclick="change_img(3)">
                       </div>
                   </div>
             </div>
      ...
      <!---Recommended products--->
        ...
        <div class="recommended">
          <h2 style="text-align:center; Color:red;">RECOMMENDED  PRODUCTS</h2>
            <div class="row">
              <div class="col-4">
              ...
              <div class="col-4">
              <a href="b_1.jsp"><img src="images/b_1_1.jpg" height="300px" width="200px"></a>
                <h4>Solid Handmade Cane Planter</h4>
                <p><sup>?</sup>400</p>
                <div class="img-btn">
                    <a href="b_1.jsp">Details</a>
                </div>
              </div>

              <div class="col-4">
              <a href="/b_6.jsp"> <img src="images/b_6_1.jpg"  height="300px" width="200px"></a>
                <h4>Tub Handmade Cane Planter</h4>
                <p><sup>?</sup>550</p>
                <div class="img-btn">
                    <a href="/b_6.jsp">Details</a>
                </div>
              </div>

              <div class="col-4">
              <a href="/b_5.jsp"><img src="images/b_5_1.jpg" height="300px" width="200px"></a>
                         ...
                         <div class="footer">
                           <div class="footer-container">
                             <div class="row">
                                 ...
                                 <a href="C:/Users/Lenovo/Desktop/Digital Village/home/home.html"><img src="C:/Users/Lenovo/Desktop/Digital Village/dv_logo.png" width:"100px" height="100px"></a>
                                     <div class="social">
