...
<div class="wrapper">
    ...
    <div class="form">
       <div class="inputfield">
          ...
          <input type="number" name="adh" class="input" placeholder="Enter correct no">
       </div>
        <div class="inputfield">
          <label>Email</label>
          <input type="text" name="mail" class="input" placeholder="Correct mail">
       </div>
      ...
      <div class="inputfield">
          ...
          <input type="password" name="conf" class="input" placeholder="Confirm Password">
       </div>
          <div class="inputfield">
      ...
      <div class="inputfield">
        <input type="submit" value="SUBMIT" name="submit" class="btn" >
         ...
         <div class="inputfield">
             <label>ALREADY EXISTING USER, PRESS LOGIN</label>
